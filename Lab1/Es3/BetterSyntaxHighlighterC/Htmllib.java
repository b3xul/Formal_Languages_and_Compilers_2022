class Htmllib {
    ...
    public static final int C_PINK   = 13;
    public static final int C_LGREY   = 14;
    ...
    public static void colPrint(int c) {
        switch(c) {
            ...
            case C_PINK:    System.out.print("<FONT color=ed00ed>"); break;
            ...
            case C_LGREY:   System.out.print("<FONT color=c0c0c0>"); break;
            default: break;
        }
    }
